...
<?php endif; ?>   
 ...
 <div class="card shadow mb-4">
                        ...
                        <a title="Cadastrar Novo Usuário" href="<?php echo base_url('usuario/addTeamMember');?>" class="btn btn-success btn-sm float-right"><i class="fas fa-user-plus"></i>&nbsp;Novo</a>
