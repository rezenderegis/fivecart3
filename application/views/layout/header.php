...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  })(window,document,'script','dataLayer','GTM-55FBCDS');</script>
  <!-- End Google Tag Manager -->
    ...
    <?php echo (isset($titulo) ? '<title>'.$titulo.'</title>' : '<title>Fivendi</title>')?>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-55FBCDS"
