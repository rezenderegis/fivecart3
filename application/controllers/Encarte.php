...
$date = date('Y-m-d H:i:s');
    ...
    public function callUrlZap() {




        redirect ("https://wa.me/5561996692868?text=Gostaria+de+Ajuda");
    ...
    public function callUrlAws($idProductList,$id_user,$id_product_publish=0,$imageQuality=0) {
        ...
        $dateGenerate = array('date_generate' => $date,);
      
        $this->core_model->update('publish', $dateGenerate, array('id' => $idProductList));

        $this->core_model->insertLog('callUrlAws', 'Gerou encarte. URL: '.$url);
